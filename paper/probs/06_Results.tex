...
\begin{figure}[H]
    ...
    \centering
         ...
         \begin{subfigure}[b]{0.47\textwidth}
             \centering
             \includegraphics[width=\textwidth]{../figures/baseline_report/fig4_2_prediction_vs_true_poverty_rate_provincia_p365_scatter.pdf}
             \caption{Poverty Line: 365}
         \end{subfigure} 
          \hfill
         \begin{subfigure}[b]{0.47\textwidth}
             \centering
             \includegraphics[width=\textwidth]{../figures/baseline_report/fig4_2_prediction_vs_true_poverty_rate_provincia_p215_scatter.pdf}
             \caption{Poverty Line: 215}
         \end{subfigure} 
    \subcaption*{Note:} 
\end{figure}
