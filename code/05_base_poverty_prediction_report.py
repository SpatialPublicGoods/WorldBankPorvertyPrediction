...
ml_dataset_filtered_validation = dpml.filter_ml_dataset(ml_dataset).query('year==2018')


# 5. Predict income
ml_dataset_filtered_train['income_pc_hat'] = ml_dataset_filtered_train['income_pc']

ml_dataset_filtered_validation['income_pc_hat'] = ml_dataset_filtered_validation['log_income_pc'] * (1.04) 
...
plt.xlim(0, 3000)
plt.legend()
plt.savefig('../figures/baseline_report/fig1_prediction_vs_true_income_distribution_lasso_training_weighted.pdf', bbox_inches='tight')
...
plt.savefig('../figures/baseline_report/fig1b_prediction_vs_true_income_ecdf_lasso_training_weighted.pdf', bbox_inches='tight')
...
plt.legend()
plt.grid(True)
plt.savefig('../figures/baseline_report/fig5_average_income_time_series.pdf', bbox_inches='tight')
...
plt.legend()
plt.grid(True)
plt.savefig('../figures/baseline_report/fig6_average_income_time_series_by_area.pdf', bbox_inches='tight')
...
plt.legend()
plt.grid(True)
plt.savefig('../figures/baseline_report/fig7_average_income_time_series_quarterly.pdf', bbox_inches='tight')
...
plt.legend()
plt.grid(True)
plt.savefig('../figures/baseline_report/fig8_poverty_rate_time_series.pdf', bbox_inches='tight')
...
plt.legend()
plt.grid(True)
plt.savefig('../figures/baseline_report/fig8a_poverty_rate_time_series_urbano.pdf', bbox_inches='tight')
...
plt.legend()
plt.grid(True)
plt.savefig('../figures/baseline_report/fig8b_poverty_rate_time_series_rural.pdf', bbox_inches='tight')
...
plt.legend()
plt.grid(True)
plt.savefig('../figures/baseline_report/fig8c_poverty_rate_time_series_lima.pdf', bbox_inches='tight')
...
plt.legend()
plt.grid(True)
plt.savefig('../figures/baseline_report/fig9_gini_time_series.pdf', bbox_inches='tight')
